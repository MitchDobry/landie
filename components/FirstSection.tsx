...
function FirstSection() {
  return (
    <section id="features">
      <div className="container flex flex-col-reverse mx-auto mt-10 md:space-y-0 md:flex-row lg:mb-24 xl:mt-9">
        <div className="flex flex-col xl:pl-114 md:w-73 lg:w-51">
